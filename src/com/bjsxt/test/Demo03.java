...
public static void main(String[] args) throws Exception {
	...
	Class<?> c = loader.loadClass("com.bjsxt.ljl.HelloWorld");
	Class<?> c2 = loader.loadClass("com.bjsxt.ljl.HelloWorld");
	Class<?> c3 = loader2.loadClass("com.bjsxt.ljl.HelloWorld"); 
	...
	System.out.println(c3.hashCode());//同一个类，被不同的加载器加载，JVM认为是不相同的类
